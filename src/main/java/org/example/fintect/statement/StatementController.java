...
public class StatementController {
    ...
    @GetMapping(StatementEndPointUtils.GET_ACCOUNT_STATEMENT_SUMMARY)
    public ResponseEntity<ApiResponse> getAllAccountsDailySummary() {
        return new ResponseEntity<>(statementService.getAllAccountsDailySummary(), HttpStatus.OK);
    }
