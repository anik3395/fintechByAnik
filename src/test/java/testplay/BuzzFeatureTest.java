...
//    }
    ...
    @Test
    public void testNavigateToMostLikedPost(){
        test.info("Testing navigate to Most Liked Post");
        page.navigate(LOGIN_URL);
        loginAsAdmin();
        test.info("Login Successful");
        page.locator("a[href='/web/index.php/buzz/viewBuzz']").click();
        test.info("Navigated to Buzz Module");
//        page.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Most Liked Posts")).click();
        Locator likedPostsBtn = page.getByRole(AriaRole.BUTTON,
                new Page.GetByRoleOptions().setName("Most Liked Posts"));
        likedPostsBtn.click();
        assertThat(likedPostsBtn).hasText("Most Liked Posts");
        test.info("Clicked on the button to view Most Liked Posts");

    }

    @Test
    public void testNavigateToMostCommentedPost(){
        test.info("Testing navigate to Most Commented Post");
        page.navigate(LOGIN_URL);
        loginAsAdmin();
        test.info("Login Successful");
        page.locator("a[href='/web/index.php/buzz/viewBuzz']").click();
        test.info("Navigated to Buzz Module");
        Locator commentedPostsBtn = page.getByRole(AriaRole.BUTTON,
                new Page.GetByRoleOptions().setName("Most Commented Posts"));
        commentedPostsBtn.click();
        assertThat(commentedPostsBtn).hasText("Most Commented Posts");
        test.info("Clicked on the button to view Most Commented Posts");
